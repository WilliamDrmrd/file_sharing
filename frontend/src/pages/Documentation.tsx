  ...
  return (
    <Box sx={{ p: 3, maxWidth: 1200, mx: "auto" }}>
      ...
      <Typography variant="body1" sx={{ mb: 4 }}>
        Welcome to SnapShare - the perfect way to share high-quality memories
        with friends. No compression, no quality loss, just your beautiful
        photos and videos exactly as they were taken.
      </Typography>
      ...
      >
        <Card sx={{ flex: 1 }}>
          <CardContent>
            ...
            <Typography variant="body2">
              Keep your memories private by optionally adding a password to your
              folder. Perfect for sharing with just your close friends from a
              trip or event without making content public. Simply share the
              password with your group along with the link.
            </Typography>
          </CardContent>
        </Card>
        ...
        <Card sx={{ flex: 1 }}>
          <CardContent>
            ...
            <Typography variant="body2">
              Download any photo or video in its original, uncompressed quality
              by clicking the download icon. Want all the memories from a trip?
              Just use the "Download All" button to get everything in a ZIP
              archive. No quality loss like on social media!
            </Typography>
          </CardContent>
        </Card>
      </Box>
      ...
      <Paper sx={{ p: 4, mb: 4 }}>
        ...
        <Alert severity="info" sx={{ mb: 3 }}>
          <Typography variant="body2" sx={{ fontWeight: 500 }}>
            Note: Only event organizers (admins) can remove photos to prevent
            accidental deletions.
          </Typography>
        </Alert>

        <Typography variant="body1" sx={{ mb: 3 }}>
          For group trip organizers and event hosts, the admin panel provides
          special functions:
        </Typography>
